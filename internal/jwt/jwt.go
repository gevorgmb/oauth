...
func (m *Manager) GenerateAccessToken(email string, uuid string, role string, name string) (string, int64, error) {
	now := time.Now()
...
func (m *Manager) GenerateRefreshToken(email string, uuid string, role string, name string) (string, int64, error) {
	now := time.Now()
